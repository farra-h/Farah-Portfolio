  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <motion.div
          variants={fadeUp}
          className="uppercase text-4xl md:text-[100px] font-extrabold leading-none font hover:scale-[1.02] transition-transform duration-500 cursor-pointer"
        >
          BEGIN SOMETHING
        </motion.div>
        <motion.p
          variants={fadeUp}
          className="mt-0 text-lg sm:text-2xl font-bold text-black dark:text-zinc-400 font"
        >
        ...
        <motion.div className="flex flex-col justify-center items-center gap-5 mt-15">
          ...
          <motion.a
            ...
            className="w-fit px-5 sm:px-12 py-5 sm:text-2xl font border-2 border-zinc-900 dark:border-zinc-100 rounded-full hover:bg-zinc-900 hover:text-white dark:hover:bg-zinc-100 dark:hover:text-black transition-all duration-300 flex items-center gap-3"
          >
          ...
          <motion.a
            ...
            className="w-fit px-5 sm:px-12 py-5 sm:text-2xl font border-2 border-green-600 text-green-600 hover:bg-green-600 hover:text-white transition-all duration-300 rounded-full flex items-center gap-3"
          >
            {/* WhatsApp SVG Icon */}
