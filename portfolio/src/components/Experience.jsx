...
const Experience = ({ fadeUp }) => {
  return (
    <motion.section id="experience" className="max-w-7xl mx-auto py-10 px-6">
      <motion.div
        variants={fadeUp}
      ...
      <div className="max-w-4xl mx-auto sm:px-6">
        <div className="mt-16 space-y-16 border-l-2 border-zinc-300 dark:border-zinc-500 pl-10 ml-4 md:ml-0">
          ...
          <div className="relative">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 mt-3 text-md sm:text-lg">
